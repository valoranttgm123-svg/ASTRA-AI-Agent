...
export const ASTRA_CAPABILITY_NODES: readonly AstraCapabilityNode[] = [
  ...
  },
  {
    ...
    layer: "doer",
    kind: "agent",
    role: "Business operations and approved computer workflows",
    capabilities: ["operations support", "workflow coordination", "approved computer actions"],
    examples: ["Build an operations checklist", "Open an approved local workflow"],
    executionAgent: "computer",
    permissionLevel: 2,
    implementation: "partial",
    defaultState: "NOT_CONFIGURED",
    requiresConfiguration: true,
  ...
  },
  {
    ...
    layer: "doer",
    kind: "tool",
    role: "Provider-neutral visual and design capability",
    capabilities: ["image generation", "image editing", "UI/visual preparation"],
    examples: ["Create a visual asset", "Edit this image"],
    permissionLevel: 2,
    implementation: "planned",
    defaultState: "NOT_CONFIGURED",
    requiresConfiguration: true,
  ...
  },
  {
    ...
    capabilities: ["CSV/JSON analysis", "metrics", "trends and anomalies"],
    permissionLevel: 1,
    implementation: "planned",
    defaultState: "NOT_CONFIGURED",
    requiresConfiguration: true,
    color: SLATE,
    visual: { x: 256, y: 388, live: false, bend: 20, radius: 5.5 },
  },
  {
    key: "crm",
    label: "CRM",
